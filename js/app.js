(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swider-hero")) new swiper_core_Swiper(".swider-hero", {
    ...
    function initSlidersTwo() {
        if (document.querySelector(".slider-bottom-contact")) new swiper_core_Swiper(".slider-bottom-contact", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            loop: true,
            navigation: {
                prevEl: ".bottom-contact__arrow_one",
                nextEl: ".bottom-contact__arrow_two"
            },
            on: {}
        });
    }
    ...
    if (isMobil.any()) {
        ...
        const arrowMenu = document.querySelectorAll(".menu__arrow");
        for (let i = 0; i < arrowMenu.length; i++) {
            let arrowActive = arrowMenu[i];
            arrowActive.nextElementSibling.hidden = true;
            arrowActive.addEventListener("click", (function(ev) {
                if (ev.target.closest(".menu__arrow")) {
                    arrowActive.parentElement.classList.toggle("_arrow-active");
                    script_slideToggle(arrowActive.nextElementSibling, 500);
                }
            }));
            document.addEventListener("click", (function(ev) {
                if (!ev.target.closest(".menu__arrow") && !ev.target.closest(".menu__sub-list")) {
                    arrowActive.parentElement.classList.remove("_arrow-active");
                    script_slideUp(arrowActive.nextElementSibling, 500);
                }
            }));
        }
    ...
    const mainInput = mainForm.email;
    ...
    function myFunction() {
        if (window.scrollY > stiki) headerConteiner.classList.add("scroll"); else headerConteiner.classList.remove("scroll");
    }
    ...
    function arrowTop() {
        const arrowControl = document.querySelector(".hero__arrow-fix");
        if (scrollY > 0) arrowControl.classList.add("arrow-top"); else arrowControl.classList.remove("arrow-top");
    }
    window["FLS"] = true;
    isWebp();
    menuInit();
